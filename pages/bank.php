  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/bank.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="col-md-12 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0"><span class="text-info text-gradient font-weight-bold">History</span> Subject Questions</h6>
            </div>
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">Which of the following was the year of world war 2?</h6>
                    <span class="mb-2 text-xs">Subject: <span class="text-dark font-weight-bold ms-sm-2">History</span></span>
                    <span class="mb-2 text-xs">Question Type: <span class="text-dark font-weight-bold ms-sm-2">MCQ</span></span>
                    <span class="mb-2 text-xs">Options: <span class="text-dark ms-sm-2 font-weight-bold">("1988" , "1940" , "1965")</span></span>
                    <span class="text-xs">Model Answer: <span class="text-dark ms-sm-2 font-weight-bold">"1939"</span></span>
                  </div>
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">Dose the two factor equation results three possibilities?</h6>
                    <span class="mb-2 text-xs">Subject: <span class="text-dark font-weight-bold ms-sm-2">Math</span></span>
                    <span class="mb-2 text-xs">Question Type: <span class="text-dark font-weight-bold ms-sm-2">True Or False</span></span>
                    <span class="text-xs">Model Answer: <span class="text-dark ms-sm-2 font-weight-bold">"True"</span></span>
                  </div>
                  <div class="ms-auto text-end">
                    <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;"><i class="far fa-trash-alt me-2"></i>Delete</a>
                    <a class="btn btn-link text-dark px-3 mb-0" href="javascript:;"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">When did MOhammed Ali Basha Died?</h6>
                    <span class="mb-2 text-xs">Subject: <span class="text-dark font-weight-bold ms-sm-2">History</span></span>
                    <span class="mb-2 text-xs">Question Type: <span class="text-dark font-weight-bold ms-sm-2">MCQ</span></span>
                    <span class="mb-2 text-xs">Options: <span class="text-dark ms-sm-2 font-weight-bold">("1988" , "1940" , "1965")</span></span>
                    <span class="text-xs">Model Answer: <span class="text-dark ms-sm-2 font-weight-bold">"1752"</span></span>
                  </div>
                  <div class="ms-auto text-end">
                    <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;"><i class="far fa-trash-alt me-2"></i>Delete</a>
                    <a class="btn btn-link text-dark px-3 mb-0" href="javascript:;"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
