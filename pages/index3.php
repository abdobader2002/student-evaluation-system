          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                <i class="fa fa-user me-2 fs-6 text-gradient text-info"></i>
              ...
              <div class="row">
                <div class="col-lg-10">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold">Built by education Experts</p>
                    <h5 class="font-weight-bolder">Evaluation System</h5>
                    <p class="mb-5">a smart, useful and reliable source for you to improve your study skills</p>
