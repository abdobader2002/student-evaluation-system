        ...
        <div class="col-lg-11 mx-auto mb-md-0 mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6><i class="fa fa-check text-info" aria-hidden="true"></i> Topics</h6>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <button type="button" class="btn btn-l bg-gradient-dark px-5" id="newtopicBtn">New Topic</button>
              </div> -->
              <div id="newTopic">
                <div class="row px-4">
                  <div class="col-10">
                  <input type="text" class="form-control form-control-lg" placeholder="Topic Title">
                  </div>
                  <div class="col-2">
                  <button type="button" class="btn bg-gradient-light w-100">Add new Topic</button>
                  </div>
                </div>
              </div>
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  ...
                  $result = mysqli_query($dbconn, $sql);
                    ...
                    <tr>
                      <td>
                          <p class="mb-0 text-sm ps-3">#<?php echo $row['topic_id'] ?></p>
                      </td>
                      <td>
