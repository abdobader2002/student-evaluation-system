  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/teachers.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6><i class="fa fa-check text-info" aria-hidden="true"></i> Teachers</h6>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <h6 class="mb-0 text-sm">Mahrous El Dab3</h6>
                    </td>
                    
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> Grade -9 </span>
                      </td>

                      <td class="align-middle">
                        <div class="d-flex justify-content-center">
                          <span class="badge bg-gradient-primary me-2">Math</span>
                          <span class="badge bg-gradient-primary me-2">Science</span>
                          <span class="badge bg-gradient-primary me-2">Arabic</span>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <h6 class="mb-0 text-sm">Kareem Banzena</h6>
                    </td>
                      ...
                      <td class="align-middle">
                        <div class="d-flex justify-content-center">
                          <span class="badge bg-gradient-primary me-2">History</span>
                          <span class="badge bg-gradient-primary me-2">Geography</span>
                        </div>
                      </td>
