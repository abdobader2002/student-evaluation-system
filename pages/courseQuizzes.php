...
if (isset($_SESSION['tid']) && isset($_GET['course_id'])) {
  $sql = "SELECT * FROM quizzes WHERE course_id = " . $_GET['course_id'];
          ...
          <?php if (mysqli_num_rows($result) > 0) {
              ...
              <div class="card card-blog card-plain">
                ...
                <div class="card-body px-1 pb-0">
                  <p class="text-gradient text-primary mb-2 text-sm"><?php echo $row2['course_name'] ?></p>
                  <a href="javascript:;">
                    <h5>
                      Quiz #<?php echo $row['quiz_id'] ?>
                    </h5>
                  </a>
                  <p class="mb-4 text-sm">
                  <?php echo $row['quiz_name'] ?>
                  </p>
                  <a href="courseQuestQuiz.php?Quiz_id=<?php echo $row['quiz_id'] ?>" class="btn btn-outline-primary btn-sm mb-0">View Quiz</a>
                </div>
              </div>
            </div>
                <?php }
            ...
            <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
              <div class="card h-100 card-plain border">
                <div class="card-body d-flex flex-column justify-content-center text-center">
                  <a href="courseQuizCreate.php?course_id=<?php echo $row2['course_id'] ?>">
                    <i class="fa fa-plus text-secondary mb-3"></i>
                    <h5 class=" text-secondary">Create New Quiz </h5>
                  </a>
                </div>
              </div>
            </div>
